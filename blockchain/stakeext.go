...
//
// This function is safe for concurrent access.
func (b *BlockChain) TicketsWithAddress(address cmmutil.Address) ([]chainhash.Hash, error) {
	b.chainLock.RLock()
	sn := b.bestNode.stakeNode
	b.chainLock.RUnlock()
...
func (b *BlockChain) TicketPoolValue() (cmmutil.Amount, error) {
	b.chainLock.RLock()
	sn := b.bestNode.stakeNode
	b.chainLock.RUnlock()
