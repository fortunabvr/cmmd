...
func TestBlock(t *testing.T) {
	b := cmmutil.NewBlock(&Block100000)
	...
	wantTxHashes := []string{
		"f455a7dee02a8af236ead1c6812a6b0e08290a4385513264f449b02c93f73238",
		"d63ddb43f394236dd810c5eed13b2eeb1016649a7274a8519424cb68eb581226",
		"93acc68ce1864e891f62f4643f1087efba5611cdbeef7581d9b75c9f5044cb7f",
		"cda7de52169b05599acb2f4e661e3885c687407eebe734eb6529cde550489346",
	}
...
func TestNewBlockFromBytes(t *testing.T) {
	...
	b, err := cmmutil.NewBlockFromBytes(block100000Bytes)
	if err != nil {
...
func TestNewBlockFromBlockAndBytes(t *testing.T) {
	...
	// Create a new block from the serialized bytes.
	b := cmmutil.NewBlockFromBlockAndBytes(&Block100000, block100000Bytes)
...
func TestBlockErrors(t *testing.T) {
	...
	testErr := cmmutil.OutOfRangeError(wantErr)
	...
	_, err = cmmutil.NewBlockFromBytes(shortBytes)
	if err != io.EOF {
	...
	_, err = b.TxHash(-1)
	if _, ok := err.(cmmutil.OutOfRangeError); !ok {
		t.Errorf("TxHash: wrong error - got: %v <%T>, "+
			"want: <%T>", err, err, cmmutil.OutOfRangeError(""))
	}
