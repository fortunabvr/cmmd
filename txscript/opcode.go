...
const (
	...
	OP_NOP9                = 0xb8 // 184
	OP_NOP10               = 0xb9 // 185
	OP_SSTX                = 0xba // 186 Commercium
	OP_SSGEN               = 0xbb // 187 Commercium
	OP_SSRTX               = 0xbc // 188 Commercium
	OP_SSTXCHANGE          = 0xbd // 189 Commercium
	OP_CHECKSIGALT         = 0xbe // 190 Commercium
	OP_CHECKSIGALTVERIFY   = 0xbf // 191 Commercium
