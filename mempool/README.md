...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/CommerciumBlockchain/cmmd/mempool)

Package mempool provides a policy-enforced pool of unmined Commercium transactions.

A key responsibility of the Commercium network is mining transactions – regular
...
Since this package does not deal with other Commercium specifics such as network
...
Commercium transactions that are not only valid by consensus rules, but also 
...
```bash
$ go get -u github.com/CommerciumBlockchain/cmmd/mempool
```
