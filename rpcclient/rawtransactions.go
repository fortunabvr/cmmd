...
func (r FutureGetRawTransactionResult) Receive() (*cmmutil.Tx, error) {
	...
	return cmmutil.NewTx(&msgTx), nil
}
...
func (c *Client) GetRawTransactionAsync(txHash *chainhash.Hash) FutureGetRawTransactionResult {
	...
	cmd := cmmjson.NewGetRawTransactionCmd(hash, cmmjson.Int(0))
...
// transaction.
func (c *Client) GetRawTransaction(txHash *chainhash.Hash) (*cmmutil.Tx, error) {
...
func (r FutureGetRawTransactionVerboseResult) Receive() (*cmmjson.TxRawResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var rawTxResult cmmjson.TxRawResult
...
func (c *Client) GetRawTransactionVerboseAsync(txHash *chainhash.Hash) FutureGetRawTransactionVerboseResult {
	...
	cmd := cmmjson.NewGetRawTransactionCmd(hash, cmmjson.Int(1))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawTransactionVerbose(txHash *chainhash.Hash) (*cmmjson.TxRawResult, error) {
...
func (r FutureDecodeRawTransactionResult) Receive() (*cmmjson.TxRawResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) DecodeRawTransactionAsync(serializedTx []byte) FutureDecodeRawTransactionResult {
	...
	cmd := cmmjson.NewDecodeRawTransactionCmd(txHex)
	return c.sendCmd(cmd)
}

// DecodeRawTransaction returns information about a transaction given its
// serialized bytes.
func (c *Client) DecodeRawTransaction(serializedTx []byte) (*cmmjson.TxRawResult, error) {
...
func (c *Client) CreateRawTransactionAsync(inputs []cmmjson.TransactionInput,
	amounts map[cmmutil.Address]cmmutil.Amount, lockTime *int64) FutureCreateRawTransactionResult {

	convertedAmts := make(map[string]float64, len(amounts))
	for addr, amount := range amounts {
		convertedAmts[addr.String()] = amount.ToCoin()
	}
	cmd := cmmjson.NewCreateRawTransactionCmd(inputs, convertedAmts, lockTime)
	return c.sendCmd(cmd)
}

// CreateRawTransaction returns a new transaction spending the provided inputs
// and sending to the provided addresses.
func (c *Client) CreateRawTransaction(inputs []cmmjson.TransactionInput,
	amounts map[cmmutil.Address]cmmutil.Amount, lockTime *int64) (*wire.MsgTx, error) {
...
type SStxCommitOut struct {
	Addr       cmmutil.Address
	CommitAmt  cmmutil.Amount
	ChangeAddr cmmutil.Address
	ChangeAmt  cmmutil.Amount
}
...
func (c *Client) CreateRawSStxAsync(inputs []cmmjson.SStxInput,
	amount map[cmmutil.Address]cmmutil.Amount,
	...
	cmd := cmmjson.NewCreateRawSStxCmd(inputs,
		convertedAmt,
		convertedCouts)
...
// and sending to the provided addresses.
func (c *Client) CreateRawSStx(inputs []cmmjson.SStxInput,
	amount map[cmmutil.Address]cmmutil.Amount,
...
func (c *Client) CreateRawSSGenTxAsync(inputs []cmmjson.TransactionInput,
	votebits uint16) FutureCreateRawSSGenTxResult {

	cmd := cmmjson.NewCreateRawSSGenTxCmd(inputs, votebits)
	return c.sendCmd(cmd)
}

// CreateRawSSGenTx returns a new transaction spending the provided inputs
// and sending to the provided addresses.
func (c *Client) CreateRawSSGenTx(inputs []cmmjson.TransactionInput,
...
func (c *Client) CreateRawSSRtxAsync(inputs []cmmjson.TransactionInput, fee cmmutil.Amount) FutureCreateRawSSRtxResult {
	feeF64 := fee.ToCoin()
	cmd := cmmjson.NewCreateRawSSRtxCmd(inputs, &feeF64)
	return c.sendCmd(cmd)
}

// CreateRawSSRtx returns a new SSR transactionm (revoking an sstx).
func (c *Client) CreateRawSSRtx(inputs []cmmjson.TransactionInput, fee cmmutil.Amount) (*wire.MsgTx, error) {
...
func (c *Client) SendRawTransactionAsync(tx *wire.MsgTx, allowHighFees bool) FutureSendRawTransactionResult {
	...
	cmd := cmmjson.NewSendRawTransactionCmd(txHex, &allowHighFees)
	return c.sendCmd(cmd)
}
...
func (r FutureSignRawTransactionResult) Receive() (*wire.MsgTx, bool, error) {
	...
	var signRawTxResult cmmjson.SignRawTransactionResult
...
func (c *Client) SignRawTransactionAsync(tx *wire.MsgTx) FutureSignRawTransactionResult {
	...
	cmd := cmmjson.NewSignRawTransactionCmd(txHex, nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignRawTransaction2Async(tx *wire.MsgTx, inputs []cmmjson.RawTxInput) FutureSignRawTransactionResult {
	txHex := ""
	if tx != nil {
		// Serialize the transaction and convert to hex string.
		buf := bytes.NewBuffer(make([]byte, 0, tx.SerializeSize()))
	...
	cmd := cmmjson.NewSignRawTransactionCmd(txHex, &inputs, nil, nil)
	return c.sendCmd(cmd)
}
...
// transactions.
func (c *Client) SignRawTransaction2(tx *wire.MsgTx, inputs []cmmjson.RawTxInput) (*wire.MsgTx, bool, error) {
...
func (c *Client) SignRawTransaction3Async(tx *wire.MsgTx,
	...
	cmd := cmmjson.NewSignRawTransactionCmd(txHex, &inputs, &privKeysWIF,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignRawTransaction4Async(tx *wire.MsgTx,
	inputs []cmmjson.RawTxInput, privKeysWIF []string,
	...
	cmd := cmmjson.NewSignRawTransactionCmd(txHex, &inputs, &privKeysWIF,
		cmmjson.String(string(hashType)))
	return c.sendCmd(cmd)
}
...
func (c *Client) SignRawSSGenTxAsync(tx *wire.MsgTx) FutureSignRawTransactionResult {
	...
	cmd := cmmjson.NewSignRawTransactionCmd(txHex, &[]cmmjson.RawTxInput{},
		nil, cmmjson.String("ssgen"))
	return c.sendCmd(cmd)
}
...
func (c *Client) SearchRawTransactionsAsync(address cmmutil.Address, skip,
	count int, reverse bool,
	filterAddrs []string) FutureSearchRawTransactionsResult {

	addr := address.EncodeAddress()
	verbose := cmmjson.Int(0)
	prevOut := cmmjson.Int(0)
	cmd := cmmjson.NewSearchRawTransactionsCmd(addr, verbose, &skip, &count,
...
func (c *Client) SearchRawTransactions(address cmmutil.Address, skip, count int,
...
// Receive waits for the response promised by the future and returns the
// found raw transactions.
func (r FutureSearchRawTransactionsVerboseResult) Receive() ([]*cmmjson.SearchRawTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var result []*cmmjson.SearchRawTransactionsResult
...
func (c *Client) SearchRawTransactionsVerboseAsync(address cmmutil.Address, skip,
...
func (c *Client) SearchRawTransactionsVerbose(address cmmutil.Address, skip,
	count int, includePrevOut bool, reverse bool,
	filterAddrs []string) ([]*cmmjson.SearchRawTransactionsResult, error) {
