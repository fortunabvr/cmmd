...
// MsgFilterAdd implements the Message interface and represents a Commercium
...
// NewMsgFilterAdd returns a new Commercium filteradd message that conforms to the
