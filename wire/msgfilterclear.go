...
// MsgFilterClear implements the Message interface and represents a Commercium
...
// NewMsgFilterClear returns a new Commercium filterclear message that conforms to the Message
