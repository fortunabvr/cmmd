...
// MsgBlock implements the Message interface and represents a Commercium
...
// BtcDecode decodes from the Commercium wire protocol as it was sent across the
...
// the Commercium wire protocol in order to be sent across the network.  The wire
...
// NewMsgBlock returns a new Commercium block message that conforms to the
