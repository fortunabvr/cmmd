...
func (view *UtxoViewpoint) AddTxOuts(tx *cmmutil.Tx, blockHeight int64, blockIndex uint32) {
	msgTx := tx.MsgTx()
...
func (view *UtxoViewpoint) connectTransaction(tx *cmmutil.Tx, blockHeight int64, blockIndex uint32, stxos *[]spentTxOut) error {
	msgTx := tx.MsgTx()
...
func (b *BlockChain) connectTransactions(view *UtxoViewpoint, block *cmmutil.Block, parent *cmmutil.Block, stxos *[]spentTxOut) error {
...
func (b *BlockChain) disconnectTransactions(view *UtxoViewpoint, block *cmmutil.Block, parent *cmmutil.Block, stxos []spentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactionSlice(transactions []*cmmutil.Tx, height int64, stxosPtr *[]spentTxOut) (int, error) {
	if stxosPtr == nil {
...
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block, parent *cmmutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *cmmutil.Tx, treeValid bool) (*UtxoViewpoint, error) {
	b.chainLock.RLock()
