...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/CommerciumBlockchain/cmmd/peer)
...
```bash
$ go get -u github.com/CommerciumBlockchain/cmmd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/CommerciumBlockchain/cmmd/peer#example-package--NewOutboundPeer)  
