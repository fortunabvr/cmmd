...
import (
	...
	"github.com/CommerciumBlockchain/cmmd/blockchain/fullblocktests"
...
func TestFullBlocks(t *testing.T) {
	// TODO: fails with following diagnostics: [signal SIGFPE: floating-point exception code=0x1 addr=0x713348 pc=0x713348]
	t.SkipNow()
	...
	testAcceptedBlock := func(item fullblocktests.AcceptedBlock) {
		...
		block := cmmutil.NewBlock(item.Block)
