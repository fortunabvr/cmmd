...
// impossible.
func checkCoinbaseUniqueHeight(blockHeight int64, block *cmmutil.Block) error {
...
func IsFinalizedTransaction(tx *cmmutil.Tx, blockHeight int64, blockTime time.Time) bool {
...
func (b *BlockChain) maybeAcceptBlock(block *cmmutil.Block, flags BehaviorFlags) (bool, error) {
