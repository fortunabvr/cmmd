...
// Peer provides a basic concurrent safe Commercium peer for handling Commercium
...
// callbacks for handling Commercium protocol messages.
//
...
// newPeerBase returns a new base Commercium peer based on the inbound flag.  This
...
// NewInboundPeer returns a new inbound Commercium peer. Use Start to begin
// processing incoming and outgoing messages.
func NewInboundPeer(cfg *Config) *Peer {
	return newPeerBase(cfg, true)
}

// NewOutboundPeer returns a new outbound Commercium peer.
