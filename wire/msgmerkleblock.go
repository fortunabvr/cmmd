...
// MsgMerkleBlock implements the Message interface and represents a Commercium
...
// NewMsgMerkleBlock returns a new Commercium merkleblock message that conforms to
