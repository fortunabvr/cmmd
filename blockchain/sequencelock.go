...
func (b *BlockChain) calcSequenceLock(node *blockNode, tx *cmmutil.Tx, view *UtxoViewpoint, isActive bool) (*SequenceLock, error) {
...
func (b *BlockChain) CalcSequenceLock(tx *cmmutil.Tx, view *UtxoViewpoint) (*SequenceLock, error) {
	b.chainLock.Lock()
