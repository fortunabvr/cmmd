...
// MsgFilterLoad implements the Message interface and represents a Commercium
...
// NewMsgFilterLoad returns a new Commercium filterload message that conforms to
