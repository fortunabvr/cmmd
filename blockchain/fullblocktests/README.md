...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/CommerciumBlockchain/cmmd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/CommerciumBlockchain/cmmd/blockchain/fullblocktests
```
