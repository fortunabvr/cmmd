...
// a single Commercium headers message.
const MaxBlockHeadersPerMsg = 2000

// MsgHeaders implements the Message interface and represents a Commercium headers
...
// NewMsgHeaders returns a new Commercium headers message that conforms to the
