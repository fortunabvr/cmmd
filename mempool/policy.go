...
const (
	...
	DefaultMinRelayTxFee = cmmutil.Amount(1e5)
...
// pool and relayed.
func calcMinRequiredTxRelayFee(serializedSize int64, minRelayTxFee cmmutil.Amount) int64 {
	...
	if minFee < 0 || minFee > cmmutil.MaxAmount {
		minFee = cmmutil.MaxAmount
	}
...
func checkInputsStandard(tx *cmmutil.Tx, txType stake.TxType, utxoView *blockchain.UtxoViewpoint) error {
...
func isDust(txOut *wire.TxOut, minRelayTxFee cmmutil.Amount) bool {
...
func checkTransactionStandard(tx *cmmutil.Tx, txType stake.TxType, height int64,
	medianTime time.Time, minRelayTxFee cmmutil.Amount,
