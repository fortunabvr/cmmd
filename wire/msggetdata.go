...
// MsgGetData implements the Message interface and represents a Commercium
...
// NewMsgGetData returns a new Commercium getdata message that conforms to the
...
// NewMsgGetDataSizeHint returns a new Commercium getdata message that conforms to
