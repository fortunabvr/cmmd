...
// MsgInv implements the Message interface and represents a Commercium inv message.
...
// NewMsgInv returns a new Commercium inv message that conforms to the Message
...
// NewMsgInvSizeHint returns a new Commercium inv message that conforms to the
