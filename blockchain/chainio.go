...
import (
	...
	"github.com/CommerciumBlockchain/cmmd/blockchain/internal/dbnamespace"
...
func serializeSizeForMinimalOutputs(tx *cmmutil.Tx) int {
...
func putTxToMinimalOutputs(target []byte, tx *cmmutil.Tx) int {
...
// already there.
func dbMaybeStoreBlock(dbTx database.Tx, block *cmmutil.Block) error {
...
// The amount is never encoded into spent transaction outputs in Commercium
...
func decodeSpentTxOut(serialized []byte, stxo *spentTxOut, amount int64, height uint32, index uint32) (int, error) {
	...
	// since in Commercium we only need pkScript at most due to fraud proofs
...
// txouts.
func dbFetchSpendJournalEntry(dbTx database.Tx, block *cmmutil.Block, parent *cmmutil.Block) ([]spentTxOut, error) {
...
func (b *BlockChain) createChainState() error {
	...
	genesisBlock := cmmutil.NewBlock(b.chainParams.GenesisBlock)
...
// from the index, and return a cmmutil.Block with the height set.
func dbFetchBlockByHash(dbTx database.Tx, hash *chainhash.Hash) (*cmmutil.Block, error) {
...
// raw block for the provided height, deserialize it, and return a cmmutil.Block
// with the height set.
func dbFetchBlockByHeight(dbTx database.Tx, height int64) (*cmmutil.Block, error) {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHeight(blockHeight int64) (*cmmutil.Block, error) {
	var block *cmmutil.Block
	err := b.db.View(func(dbTx database.Tx) error {
		var err error
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHash(hash *chainhash.Hash) (*cmmutil.Block, error) {
	b.chainLock.RLock()
