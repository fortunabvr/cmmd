...
/*
Package peer provides a common base for creating and managing Commercium network
peers.

Overview

This package builds upon the wire package, which provides the fundamental
primitives necessary to speak the Commercium wire protocol, in order to simplify
...
A quick overview of the major features peer provides are as follows:
 ...
 - Provides a basic concurrent safe Commercium peer for handling Commercium
   communications via the peer-to-peer protocol
 - Full duplex reading and writing of Commercium protocol messages
 ...
 - Flexible peer configuration
   ...
   - Ability to register callbacks for handling Commercium protocol messages
...
caller to specify things such as the user agent name and version, the Commercium
network to use, which services it supports, and callbacks to invoke when Commercium
...
In order to do anything useful with a peer, it is necessary to react to Commercium
...
For convenience, a callback hook for all of the currently supported Commercium
...
(https://godoc.org/github.com/CommerciumBlockchain/cmmd/wire#hdr-Bitcoin_Improvement_Proposals)
*/
package peer
