...
/*
Package addrmgr implements concurrency safe Commercium address manager.

Address Manager Overview

In order maintain the peer-to-peer Commercium network, there needs to be a source
of addresses to connect to as nodes come and go.  The Commercium protocol provides
