...
func BlockOneCoinbasePaysTokens(tx *cmmutil.Tx, params *chaincfg.Params) error {
	...
	for i, txout := range tx.MsgTx().TxOut {
		...
		addrLedger, err := cmmutil.DecodeAddress(ledger[i].Address)
		if err != nil {
			return err
		}
...
func CalculateAddedSubsidy(block, parent *cmmutil.Block) int64 {
	var subsidy int64
