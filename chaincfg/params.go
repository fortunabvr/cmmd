...
var (
	...
	// simNetPowLimit is the highest proof of work value a Commercium block
...
// Params defines a Commercium network by its parameters.  These parameters may be
// used by Commercium applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// Ticket pool sizes for Commercium PoS. This denotes the number of possible
	...
	// Average number of tickets per block for Commercium PoS.
...
// MainNetParams defines the network parameters for the main Commercium network.
var MainNetParams = Params{
	Name:        "mainnet",
	Net:         wire.MainNet,
	DefaultPort: "2018",
	DNSSeeds: []DNSSeed{
                {"seed1.commercium.net", true},
                {"seed2.commercium.net", true},
                {"seed3.commercium.net", true},
		{"seed4.commercium.net", true},
	},
	...
	// ---------------------------------------------------------------------------------------------
	PubKeyAddrID:     [2]byte{0x28, 0xdc}, // starts with Cs	-- no such addresses should exist in RL
	PubKeyHashAddrID: [2]byte{0x28}, // starts with C
	PKHEdwardsAddrID: [2]byte{0x28, 0xcf}, // starts with Ce
	PKHSchnorrAddrID: [2]byte{0x28, 0x0d}, // starts with CS
	ScriptHashAddrID: [2]byte{0x50}, // starts with M
	PrivateKeyID:     0x140,                // starts with 5 (uncompressed) or M (compressed)
	// ---------------------------------------------------------------------------------------------
	...
	// Commercium organization related parameters
...
var TestNetParams = Params{
	...
	DefaultPort: "12018",
	DNSSeeds: []DNSSeed{
		{"testnet-seed.commercium.net", true},
	},
	N: 144,
	K: 5,
...
// SimNetParams defines the network parameters for the simulation test Commercium
...
var (
	// ErrDuplicateNet describes an error where the parameters for a Commercium
	// network could not be set due to the network already being a standard
	// network or previously-registered into this package.
	ErrDuplicateNet = errors.New("duplicate Commercium network")
...
// Register registers the network parameters for a Commercium network.  This may
