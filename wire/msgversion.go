...
const DefaultUserAgent = "/cmmwire:0.3.0/"

// MsgVersion implements the Message interface and represents a Commercium version
...
// NewMsgVersion returns a new Commercium version message that conforms to the
...
// and local address from conn and returns a new Commercium version message that
