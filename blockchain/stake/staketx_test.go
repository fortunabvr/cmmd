...
func TestSStx(t *testing.T) {
	var sstx = cmmutil.NewTx(sstxMsgTx)
	...
	sstx = cmmutil.NewTxDeep(sstxMsgTx)
...
func TestSSTxErrors(t *testing.T) {
	...
	var sstxExtraInputs = cmmutil.NewTx(sstxMsgTxExtraInput)
	...
	var sstxExtraOutputs = cmmutil.NewTx(sstxMsgTxExtraOutputs)
	...
	var sstxUntaggedOut = cmmutil.NewTx(&tx)
	...
	var sstxInsOutsMismatched = cmmutil.NewTx(sstxMismatchedInsOuts)
	...
	var sstxBadVerOut = cmmutil.NewTx(sstxBadVersionOut)
	...
	var sstxNoNullData = cmmutil.NewTx(sstxNullDataMissing)
	...
	var sstxNullDataMis = cmmutil.NewTx(sstxNullDataMisplaced)
	...
	var sstxWrongPKHLength = cmmutil.NewTx(&tx)
	...
	var sstxWrongPrefix = cmmutil.NewTx(&tx)
...
func TestSSGen(t *testing.T) {
	var ssgen = cmmutil.NewTx(ssgenMsgTx)
	...
	ssgen = cmmutil.NewTxDeep(ssgenMsgTx)
	ssgen.SetTree(wire.TxTreeStake)
	ssgen.SetIndex(0)
...
func TestSSGenErrors(t *testing.T) {
	...
	var ssgenExtraInputs = cmmutil.NewTx(ssgenMsgTxExtraInput)
	...
	var ssgenExtraOutputs = cmmutil.NewTx(ssgenMsgTxExtraOutputs)
	...
	var ssgenStakeBaseWrong = cmmutil.NewTx(ssgenMsgTxStakeBaseWrong)
	...
	var ssgenWrongTreeIns = cmmutil.NewTx(&tx)
	...
	// ---------------------------------------------------------------------------
	// Test for bad version of output.
	var ssgenTxBadVerOut = cmmutil.NewTx(ssgenMsgTxBadVerOut)
	...
	var ssgenWrongZeroethOut = cmmutil.NewTx(ssgenMsgTxWrongZeroethOut)
	...
	var ssgenWrongDataPush0Length = cmmutil.NewTx(&tx)
	...
	var ssgenWrongNullData0Prefix = cmmutil.NewTx(&tx)
	...
	var ssgenWrongFirstOut = cmmutil.NewTx(ssgenMsgTxWrongFirstOut)
	...
	var ssgenWrongDataPush1Length = cmmutil.NewTx(&tx)
	...
	var ssgenWrongNullData1Prefix = cmmutil.NewTx(&tx)
	...
	var ssgentestGenOutputUntagged = cmmutil.NewTx(&tx)
...
func TestSSRtx(t *testing.T) {
	var ssrtx = cmmutil.NewTx(ssrtxMsgTx)
...
func TestIsSSRtxErrors(t *testing.T) {
	...
	var ssrtxTooManyInputs = cmmutil.NewTx(ssrtxMsgTxTooManyInputs)
	...
	var ssrtxTooManyOutputs = cmmutil.NewTx(ssrtxMsgTxTooManyOutputs)
	...
	// ---------------------------------------------------------------------------
	// Test for bad version of output.
	var ssrtxTxBadVerOut = cmmutil.NewTx(ssrtxMsgTxBadVerOut)
	...
	var ssrtxTestRevocOutputUntagged = cmmutil.NewTx(&tx)
	...
	var ssrtxWrongTreeIns = cmmutil.NewTx(&tx)
...
func TestVerifyRealTxs(t *testing.T) {
	...
	ssrtxTx := cmmutil.NewTx(ssrtxMtx)
