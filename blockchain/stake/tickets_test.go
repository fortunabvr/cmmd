...
import (
	...
	"github.com/CommerciumBlockchain/cmmd/blockchain/stake/internal/tickettreap"
...
func ticketsInBlock(bl *cmmutil.Block) []chainhash.Hash {
...
func ticketsSpentInBlock(bl *cmmutil.Block) []chainhash.Hash {
...
func revokedTicketsInBlock(bl *cmmutil.Block) []chainhash.Hash {
...
func TestTicketDBLongChain(t *testing.T) {
	...
	testBlockchain := make(map[int64]*cmmutil.Block, len(testBlockchainBytes))
	for k, v := range testBlockchainBytes {
		bl, err := cmmutil.NewBlockFromBytes(v)
		if err != nil {
