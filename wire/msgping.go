...
// MsgPing implements the Message interface and represents a Commercium ping
// message.
//
...
// NewMsgPing returns a new Commercium ping message that conforms to the Message
