...
func TestChainSvrWsNtfns(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "blockconnected",
			newNtfn: func() (interface{}, error) {
				return cmmjson.NewCmd("blockconnected", "header", []string{"tx0", "tx1"})
			},
			staticNtfn: func() interface{} {
				return cmmjson.NewBlockConnectedNtfn("header", []string{"tx0", "tx1"})
			},
			marshalled: `{"jsonrpc":"1.0","method":"blockconnected","params":["header",["tx0","tx1"]],"id":null}`,
			unmarshalled: &cmmjson.BlockConnectedNtfn{
				Header:        "header",
		...
		},
		{
			...
			newNtfn: func() (interface{}, error) {
				return cmmjson.NewCmd("blockdisconnected", "header")
			},
			staticNtfn: func() interface{} {
				return cmmjson.NewBlockDisconnectedNtfn("header")
			},
			marshalled: `{"jsonrpc":"1.0","method":"blockdisconnected","params":["header"],"id":null}`,
			unmarshalled: &cmmjson.BlockDisconnectedNtfn{
				Header: "header",
			},
		},
		{
			...
			newNtfn: func() (interface{}, error) {
				return cmmjson.NewCmd("relevanttxaccepted", "001122")
			},
			staticNtfn: func() interface{} {
				return cmmjson.NewRelevantTxAcceptedNtfn("001122")
			},
			marshalled: `{"jsonrpc":"1.0","method":"relevanttxaccepted","params":["001122"],"id":null}`,
			unmarshalled: &cmmjson.RelevantTxAcceptedNtfn{
				Transaction: "001122",
			},
		},
		{
			name: "txaccepted",
			newNtfn: func() (interface{}, error) {
				return cmmjson.NewCmd("txaccepted", "123", 1.5)
			},
			staticNtfn: func() interface{} {
				return cmmjson.NewTxAcceptedNtfn("123", 1.5)
			},
			marshalled: `{"jsonrpc":"1.0","method":"txaccepted","params":["123",1.5],"id":null}`,
			unmarshalled: &cmmjson.TxAcceptedNtfn{
				TxID:   "123",
				Amount: 1.5,
			},
		},
		{
			...
			newNtfn: func() (interface{}, error) {
				return cmmjson.NewCmd("txacceptedverbose", `{"hex":"001122","txid":"123","version":1,"locktime":4294967295,"vin":null,"vout":null,"confirmations":0}`)
			},
			staticNtfn: func() interface{} {
				txResult := cmmjson.TxRawResult{
					Hex:           "001122",
					Txid:          "123",
					Version:       1,
					LockTime:      4294967295,
				...
				return cmmjson.NewTxAcceptedVerboseNtfn(txResult)
			},
			...
			unmarshalled: &cmmjson.TxAcceptedVerboseNtfn{
				RawTx: cmmjson.TxRawResult{
					Hex:           "001122",
					Txid:          "123",
					Version:       1,
					LockTime:      4294967295,
