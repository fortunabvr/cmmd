...
// units, "1eN CMM" is returned, where N is the AmountUnit.
func (u AmountUnit) String() string {
	...
	case AmountAtom:
		return "Atom"
	default:
		return "1e" + strconv.FormatInt(int64(u), 10) + " CMM"
	}
}
...
//
// NewAmount is for specifically for converting CMM to Atoms (atomic units).
...
// See GoDoc for example: http://godoc.org/github.com/CommerciumBlockchain/cmmd/cmmutil#example-Amount
...
// useful for services that build on top of Commercium (for example, calculating
