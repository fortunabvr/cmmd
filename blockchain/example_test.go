...
// overview documentation describes, this includes all of the Commercium consensus
...
func ExampleBlockChain_ProcessBlock() {
	...
	// exists.
	genesisBlock := cmmutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
...
func ExampleCompactToBig() {
	// Convert the bits from block 300000 in the main Commercium block chain.
