...
// MsgGetBlocks implements the Message interface and represents a Commercium
...
// NewMsgGetBlocks returns a new Commercium getblocks message that conforms to the
