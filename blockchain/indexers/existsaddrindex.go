...
func (idx *ExistsAddrIndex) ExistsAddress(addr cmmutil.Address) (bool, error) {
...
func (idx *ExistsAddrIndex) ExistsAddresses(addrs []cmmutil.Address) ([]bool, error) {
...
//
// This is part of the Indexer interface.
func (idx *ExistsAddrIndex) ConnectBlock(dbTx database.Tx, block, parent *cmmutil.Block, view *blockchain.UtxoViewpoint) error {
	var parentTxs []*cmmutil.Tx
...
//
// This is part of the Indexer interface.
func (idx *ExistsAddrIndex) DisconnectBlock(dbTx database.Tx, block, parent *cmmutil.Block, view *blockchain.UtxoViewpoint) error {
	return nil
}
