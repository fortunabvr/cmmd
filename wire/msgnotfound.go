...
// MsgNotFound defines a Commercium notfound message which is sent in response to
...
// NewMsgNotFound returns a new Commercium notfound message that conforms to the
