...
//
// In addition to the main Commercium network, which is intended for the transfer
...
// wire.CMMNet using ParamsForNet, but be aware that this usage is
...
//          addr, err := cmmutil.NewAddressPubKeyHash(pubKeyHash, chainParams)
//          if err != nil {
//                  log.Fatal(err)
//          }
//          fmt.Println(addr)
//  }
//
// If an application does not use one of the three standard Commercium networks,
