...
// MsgGetHeaders implements the Message interface and represents a Commercium
...
// NewMsgGetHeaders returns a new Commercium getheaders message that conforms to
