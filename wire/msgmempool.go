...
// MsgMemPool implements the Message interface and represents a Commercium mempool
...
// NewMsgMemPool returns a new Commercium pong message that conforms to the Message
