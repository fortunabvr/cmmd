...
func TestTx(t *testing.T) {
	...
	wantHashStr := "f455a7dee02a8af236ead1c6812a6b0e08290a4385513264f449b02c93f73238"
...
func TestNewTxFromBytes(t *testing.T) {
	...
	tx, err := cmmutil.NewTxFromBytes(testTxBytes)
	if err != nil {
...
func TestTxErrors(t *testing.T) {
	...
	_, err = cmmutil.NewTxFromBytes(shortBytes)
	if err != io.EOF {
