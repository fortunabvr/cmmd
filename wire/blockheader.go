...
// BlockHeader defines information about a block and is used in the Commercium
...
// readBlockHeader reads a Commercium block header from r.  See Deserialize for
...
// writeBlockHeader writes a Commercium block header to w.  See Serialize for
