...
/*
cmmd is a full-node Commercium implementation written in Go.

The default options are sane for most users.  This means cmmd will work 'out of
...
parsed when cmmd starts up.  By default, the configuration file is located at
~/.cmmd/cmmd.conf on POSIX-style operating systems and %LOCALAPPDATA%\cmmd\cmmd.conf
...
Application Options:
  ...
  -d, --debuglevel=         Logging level for all subsystems {trace, debug,
      ...
      --minrelaytxfee=      The minimum transaction fee in CMM/kB to be
