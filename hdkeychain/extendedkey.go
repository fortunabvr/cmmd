...
import (
	...
	"github.com/CommerciumBlockchain/base58"
...
func (k *ExtendedKey) Child(i uint32) (*ExtendedKey, error) {
	...
	parentFP := cmmutil.Hash160(k.pubKeyBytes())[:4]
...
// ECPubKey converts the extended key to a cmmec public key and returns it.
func (k *ExtendedKey) ECPubKey() (chainec.PublicKey, error) {
	return chainec.Secp256k1.ParsePubKey(k.pubKeyBytes())
}

// ECPrivKey converts the extended key to a cmmec private key and returns it.
...
// Address converts the extended key to a standard Commercium pay-to-pubkey-hash
// address for the passed network.
func (k *ExtendedKey) Address(net *chaincfg.Params) (*cmmutil.AddressPubKeyHash, error) {
	pkHash := cmmutil.Hash160(k.pubKeyBytes())
	return cmmutil.NewAddressPubKeyHash(pkHash, net, chainec.ECTypeSecp256k1)
}
