...
/*
Package txscript implements the Commercium transaction script language.

This package provides data structures and functions to parse and execute
Commercium transaction scripts.

Script Overview

Commercium transaction scripts are written in a stack-base, FORTH-like language.

The Commercium script language consists of a number of opcodes which fall into
...
The vast majority of Commercium scripts at the time of this writing are of several
...
what conditions must be met in order to spend cmms.
