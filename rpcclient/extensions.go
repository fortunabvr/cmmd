...
//
// NOTE: This is a cmmd extension.
func (c *Client) DebugLevelAsync(levelSpec string) FutureDebugLevelResult {
	cmd := cmmjson.NewDebugLevelCmd(levelSpec)
	return c.sendCmd(cmd)
}
...
func (r FutureEstimateStakeDiffResult) Receive() (*cmmjson.EstimateStakeDiffResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var est cmmjson.EstimateStakeDiffResult
...
func (c *Client) EstimateStakeDiffAsync(tickets *uint32) FutureEstimateStakeDiffResult {
	cmd := cmmjson.NewEstimateStakeDiffCmd(tickets)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a cmmd extension.
func (c *Client) EstimateStakeDiff(tickets *uint32) (*cmmjson.EstimateStakeDiffResult, error) {
...
// result of the RPC at some future time by invoking the Receive function on the
// returned instance.
func (c *Client) ExistsAddressAsync(address cmmutil.Address) FutureExistsAddressResult {
	cmd := cmmjson.NewExistsAddressCmd(address.EncodeAddress())
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a cmmd extension.
func (c *Client) ExistsAddress(address cmmutil.Address) (bool, error) {
...
// result of the RPC at some future time by invoking the Receive function on the
// returned instance.
func (c *Client) ExistsAddressesAsync(addresses []cmmutil.Address) FutureExistsAddressesResult {
	addrsStr := make([]string, len(addresses))
	for i := range addresses {
		addrsStr[i] = addresses[i].EncodeAddress()
	}

	cmd := cmmjson.NewExistsAddressesCmd(addrsStr)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a cmmd extension.
func (c *Client) ExistsAddresses(addresses []cmmutil.Address) (string, error) {
...
func (c *Client) ExistsMissedTicketsAsync(hashes []*chainhash.Hash) FutureExistsMissedTicketsResult {
	...
	cmd := cmmjson.NewExistsMissedTicketsCmd(hex.EncodeToString(hashBlob))
	return c.sendCmd(cmd)
}
...
func (c *Client) ExistsExpiredTicketsAsync(hashes []*chainhash.Hash) FutureExistsExpiredTicketsResult {
	...
	cmd := cmmjson.NewExistsExpiredTicketsCmd(hex.EncodeToString(hashBlob))
	return c.sendCmd(cmd)
}
...
func (c *Client) ExistsLiveTicketAsync(hash *chainhash.Hash) FutureExistsLiveTicketResult {
	cmd := cmmjson.NewExistsLiveTicketCmd(hash.String())
	return c.sendCmd(cmd)
}
...
func (c *Client) ExistsLiveTicketsAsync(hashes []*chainhash.Hash) FutureExistsLiveTicketsResult {
	...
	cmd := cmmjson.NewExistsLiveTicketsCmd(hex.EncodeToString(hashBlob))
	return c.sendCmd(cmd)
}
...
func (c *Client) ExistsMempoolTxsAsync(hashes []*chainhash.Hash) FutureExistsMempoolTxsResult {
	...
	cmd := cmmjson.NewExistsMempoolTxsCmd(hex.EncodeToString(hashBlob))
	return c.sendCmd(cmd)
}
...
func (c *Client) ExportWatchingWalletAsync(account string) FutureExportWatchingWalletResult {
	cmd := cmmjson.NewExportWatchingWalletCmd(&account, cmmjson.Bool(true))
	return c.sendCmd(cmd)
}
...
// used by cmmwallet to enable a wallet which does not have the private keys
...
func (r FutureGetBestBlockResult) Receive() (*chainhash.Hash, int64, error) {
	...
	var bestBlock cmmjson.GetBestBlockResult
...
func (c *Client) GetBestBlockAsync() FutureGetBestBlockResult {
	cmd := cmmjson.NewGetBestBlockCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) GetCurrentNetAsync() FutureGetCurrentNetResult {
	cmd := cmmjson.NewGetCurrentNetCmd()
	return c.sendCmd(cmd)
}
...
// Receive waits for the response promised by the future and returns the
// getheaders result.
func (r FutureGetHeadersResult) Receive() (*cmmjson.GetHeadersResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var vr cmmjson.GetHeadersResult
...
func (c *Client) GetHeadersAsync(blockLocators []*chainhash.Hash, hashStop *chainhash.Hash) FutureGetHeadersResult {
	...
	cmd := cmmjson.NewGetHeadersCmd(hex.EncodeToString(concatenatedLocators),
		hashStop.String())
	return c.sendCmd(cmd)
}
...
func (c *Client) GetHeaders(blockLocators []*chainhash.Hash, hashStop *chainhash.Hash) (*cmmjson.GetHeadersResult, error) {
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetStakeDifficultyResult) Receive() (*cmmjson.GetStakeDifficultyResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	// Unmarshal result as a cmmjson.GetStakeDifficultyResult.
	var gsdr cmmjson.GetStakeDifficultyResult
...
func (c *Client) GetStakeDifficultyAsync() FutureGetStakeDifficultyResult {
	cmd := cmmjson.NewGetStakeDifficultyCmd()
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a cmmd extension.
func (c *Client) GetStakeDifficulty() (*cmmjson.GetStakeDifficultyResult, error) {
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetStakeVersionsResult) Receive() (*cmmjson.GetStakeVersionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	// Unmarshal result as a cmmjson.GetStakeVersionsResult.
	var gsvr cmmjson.GetStakeVersionsResult
...
func (c *Client) GetStakeVersionInfoAsync(count int32) FutureGetStakeVersionInfoResult {
	cmd := cmmjson.NewGetStakeVersionInfoCmd(count)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a cmmd extension.
func (c *Client) GetStakeVersionInfo(count int32) (*cmmjson.GetStakeVersionInfoResult, error) {
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetStakeVersionInfoResult) Receive() (*cmmjson.GetStakeVersionInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	// Unmarshal result as a cmmjson.GetStakeVersionInfoResult.
	var gsvr cmmjson.GetStakeVersionInfoResult
	err = json.Unmarshal(res, &gsvr)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetStakeVersionsAsync(hash string, count int32) FutureGetStakeVersionsResult {
	cmd := cmmjson.NewGetStakeVersionsCmd(hash, count)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a cmmd extension.
func (c *Client) GetStakeVersions(hash string, count int32) (*cmmjson.GetStakeVersionsResult, error) {
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetTicketPoolValueResult) Receive() (cmmutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetTicketPoolValueAsync() FutureGetTicketPoolValueResult {
	cmd := cmmjson.NewGetTicketPoolValueCmd()
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a cmmd extension.
func (c *Client) GetTicketPoolValue() (cmmutil.Amount, error) {
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetVoteInfoResult) Receive() (*cmmjson.GetVoteInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	// Unmarshal result as a cmmjson.GetVoteInfoResult.
	var gsvr cmmjson.GetVoteInfoResult
	err = json.Unmarshal(res, &gsvr)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetVoteInfoAsync(version uint32) FutureGetVoteInfoResult {
	cmd := cmmjson.NewGetVoteInfoCmd(version)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a cmmd extension.
func (c *Client) GetVoteInfo(version uint32) (*cmmjson.GetVoteInfoResult, error) {
...
func (r FutureListAddressTransactionsResult) Receive() ([]cmmjson.ListTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
//
// NOTE: This is a cmmd extension.
func (c *Client) ListAddressTransactionsAsync(addresses []cmmutil.Address, account string) FutureListAddressTransactionsResult {
	// Convert addresses to strings.
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.EncodeAddress())
	}
	cmd := cmmjson.NewListAddressTransactionsCmd(addrs, &account)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a cmmwallet extension.
func (c *Client) ListAddressTransactions(addresses []cmmutil.Address, account string) ([]cmmjson.ListTransactionsResult, error) {
...
func (r FutureLiveTicketsResult) Receive() ([]*chainhash.Hash, error) {
	...
	// Unmarshal the result as a cmmjson.LiveTicketsResult.
	var container cmmjson.LiveTicketsResult
...
func (r FutureMissedTicketsResult) Receive() ([]*chainhash.Hash, error) {
	...
	// Unmarshal the result as a cmmjson.MissedTicketsResult.
	var container cmmjson.MissedTicketsResult
	err = json.Unmarshal(res, &container)
	if err != nil {
		return nil, err
	}
...
func (c *Client) MissedTicketsAsync() FutureMissedTicketsResult {
	cmd := cmmjson.NewMissedTicketsCmd()
	return c.sendCmd(cmd)
}
...
// Receive waits for the response promised by the future and returns the
// session result.
func (r FutureSessionResult) Receive() (*cmmjson.SessionResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var session cmmjson.SessionResult
...
//
// NOTE: This is a Commercium extension.
...
//
// NOTE: This is a Commercium extension.
func (c *Client) Session() (*cmmjson.SessionResult, error) {
...
func (r FutureTicketFeeInfoResult) Receive() (*cmmjson.TicketFeeInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var tfir cmmjson.TicketFeeInfoResult
...
func (c *Client) TicketFeeInfoAsync(blocks *uint32, windows *uint32) FutureTicketFeeInfoResult {
	...
	cmd := cmmjson.NewTicketFeeInfoCmd(blocks, windows)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a Commercium extension.
func (c *Client) TicketFeeInfo(blocks *uint32, windows *uint32) (*cmmjson.TicketFeeInfoResult, error) {
...
// Receive waits for the response promised by the future and returns the
// ticketvwap result.
func (r FutureTicketVWAPResult) Receive() (cmmutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amt, err := cmmutil.NewAmount(vwap)
	if err != nil {
		return 0, err
	}
...
func (c *Client) TicketVWAPAsync(start *uint32, end *uint32) FutureTicketVWAPResult {
	...
	cmd := cmmjson.NewTicketVWAPCmd(start, end)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a Commercium extension.
func (c *Client) TicketVWAP(start *uint32, end *uint32) (cmmutil.Amount, error) {
...
// Receive waits for the response promised by the future and returns the
// txfeeinfo result.
func (r FutureTxFeeInfoResult) Receive() (*cmmjson.TxFeeInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var tfir cmmjson.TxFeeInfoResult
	err = json.Unmarshal(res, &tfir)
	if err != nil {
		return nil, err
	}
...
func (c *Client) TxFeeInfoAsync(blocks *uint32, start *uint32, end *uint32) FutureTxFeeInfoResult {
	...
	cmd := cmmjson.NewTxFeeInfoCmd(blocks, start, end)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a Commercium extension.
func (c *Client) TxFeeInfo(blocks *uint32, start *uint32, end *uint32) (*cmmjson.TxFeeInfoResult, error) {
...
// result.
func (r FutureVersionResult) Receive() (map[string]cmmjson.VersionResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var vr map[string]cmmjson.VersionResult
	err = json.Unmarshal(res, &vr)
	if err != nil {
		return nil, err
	}
...
func (c *Client) VersionAsync() FutureVersionResult {
	cmd := cmmjson.NewVersionCmd()
	return c.sendCmd(cmd)
}

// Version returns information about the server's JSON-RPC API versions.
func (c *Client) Version() (map[string]cmmjson.VersionResult, error) {
