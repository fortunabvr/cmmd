...
// maxNetAddressPayload returns the max payload size for a Commercium NetAddress
...
type NetAddress struct {
	...
	// not present in the Commercium version message (MsgVersion) nor was it
...
func readNetAddress(r io.Reader, pver uint32, na *NetAddress, ts bool) error {
	...
	// NOTE: The Commercium protocol uses a uint32 for the timestamp so it will
	...
	// Sigh.  Commercium protocol mixes little and big endian.
