...
var (
	...
	// of the block chain.
	blockDataFile = filepath.Join("..", "..", "blockchain", "testdata", "blocks0to168.cmmd.json.gz")
...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.CurrencyNet) ([]*cmmutil.Block, error) {
	...
	for i := 0; i < 168; i++ {
		...
		blocks[i] = cmmutil.NewBlock(&jsbl.MsgBlock)
	}
