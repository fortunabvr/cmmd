...
// MsgReject implements the Message interface and represents a Commercium reject
// message.
//
...
func (msg *MsgReject) MaxPayloadLength(pver uint32) uint32 {
	// Unfortunately the Commercium protocol does not enforce a sane
...
// NewMsgReject returns a new Commercium reject message that conforms to the
